...
from core.modules.diffusionmodules.basic_module import FullyConnectedLayer, Conv2dLayer, MappingNet, MinibatchStdLayer, DisFromRGB, DisBlock, StyleConv, ToRGB, get_style_code
...
class SynthesisNet(nn.Module):
    def __init__(self,
        ...
        # two-stage framework: frist stage to synthesize and second stage to refine with a Conv-U-Net
